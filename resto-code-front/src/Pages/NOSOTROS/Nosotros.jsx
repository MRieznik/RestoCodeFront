      ...
      <main className="contenedorPrincipalAbout">
        ...
        <div className="bloqueUnoDeABout">
          <div className="cajaInfoMasImagenAbout">
            ...
            <p>
              Sumérgete en el Mundo de Nuestras Cervezas Artesanales, Donde la
              Pasión y la Creatividad se Unen para Brindarte Experiencias Únicas
          ...
          <div className="cajaInfoMasImagenAbout noneEnResponsive">
            ...
            <p>
              Pasión y Creatividad se Materializan en Sabores Inolvidables y
              Experiencias que Deleitan el Paladar.
            </p>
          </div>
          <div className="cajaInfoMasImagenAbout noneEnResponsive">
        ...
        <section className="contenedor_cards">
          <article className="contenedor_item">
            <div className="card_contenido">
              ...
              />
              <div className="card_texto align-items-center">
          ...
          <article className="contenedor_item">
            <div className="card_contenido">
              ...
              <div className="iconos_redes">
                <a href="https://www.linkedin.com/in/luisina-martinez/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                ...
                <a href="https://github.com/luumartinez">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
